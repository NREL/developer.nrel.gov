    ...
    "Site": {
      ...
      "Financial": {
        ...
        "simple_payback_years": {
          "type": "float",
          "description": "Number of years until the cumulative annual cashflow turns positive. If the cashflow becomes negative again after becoming positive (i.e. due to battery repalcement costs) then simple payback is increased by the number of years that the cash flow is negative beyond the break-even year.",
          "units": "$"
        },
        "irr_pct": {
          "type": "float",
          "description": "Internal Rate of Return of the cost-optimal system. In two-party cases the developer discount rate is used in place of the offtaker discount rate.",
          "units": "%"
        },
        "net_present_cost_us_dollars": {
          "type": "float",
          "description": "Present value of the total costs incurred by the third-party owning and operating the distributed energy resource assets.",
          "units": "$"
        },
      ...
      "ElectricTariff": {
        ...
        "year_one_emissions_lb_C02": {
          "type": "int",
          "description": "Total equivalent pounds of carbon dioxide emitted from utility electricity use in the first year. Calculated from EPA AVERT region hourly grid emissions factor series for the continental US.In AK and HI, the best available data are EPA eGRID annual averages.",
          "units": "lb CO2"
        },
        "year_one_emissions_bau_lb_C02": {
          "type": "int",
